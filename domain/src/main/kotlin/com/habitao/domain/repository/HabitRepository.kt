...
interface HabitRepository {
    ...
    suspend fun createOrUpdateLog(habitId: String, date: LocalDate, count: Int): Result<Unit>
    
    suspend fun getLogForHabitAndDate(habitId: String, date: LocalDate): Result<HabitLog?>
    ...
    suspend fun archiveHabit(habitId: String, archive: Boolean = true): Result<Unit>
}
